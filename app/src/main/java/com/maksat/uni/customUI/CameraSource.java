 ...
 * {@link com.maksat.uni.customUI.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource {
    ...
    public static class Builder {
        ...
        private com.maksat.uni.customUI.CameraSource cameraSource = new com.maksat.uni.customUI.CameraSource();
         ...
         */
        public com.maksat.uni.customUI.CameraSource build() {
    ...
    public com.maksat.uni.customUI.CameraSource start() throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public com.maksat.uni.customUI.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
    ...
    private class PictureDoneCallback implements Camera.PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            synchronized (cameraLock) {
                if (com.maksat.uni.customUI.CameraSource.this.camera != null) {
                    com.maksat.uni.customUI.CameraSource.this.camera.startPreview();
                }
            }
        }
    }
